...
import api_URL, { categories } from "../apiURL/apiURL";
              ...
              <IonRow>
                <IonCol size="12">
                  <IonCardTitle class="projectCardTitle  ion-margin-top lineAroundText">
                    ...
                    >
                      {this.state.room == "livingroom" ||
                      this.state.room == "livingRoom"
                        ? "living Room"
                        : this.state.room == "livingRoom2" ||
                          this.state.room == "livingroom2"
                        ? "living Room 2"
                        : this.state.room == "Bedroom1" ||
                          this.state.room == "bedroom1"
                        ? "Bedroom 1"
                        : this.state.room == "Bedroom2" ||
                          this.state.room == "bedroom2"
                        ? "Bedroom 2"
                        : this.state.room == "DiningRoom" ||
                          this.state.room == "diningroom"
                        ? "Dining Room"
                        : this.state.room == "Kitchen" ||
                          this.state.room == "kitchen"
                        ? "Kitchen"
                        : this.state.room == "OutsideSpace" ||
                          this.state.room == "outsidespace"
                        ? "Outside Space"
                        : this.state.room == "Office" ||
                          this.state.room == "office"
                        ? "Office"
                        : `${this.state.room}`}{" "}
                      Project
