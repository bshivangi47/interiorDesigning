...
class FinalCart extends React.Component {
  ...
  async componentDidUpdate(prevProps) {
    ...
    if (this.props.pastOrders != prevProps.pastOrders) {
      if (this.props.pastOrders.success == true) {
        let SubtotalClient = 0;
        let SubtotalDesigner = 0;
        this.setState({
          AddedTocart: false,
          cartItems: this.props.pastOrders.message,
        });
        this.props.pastOrders.message.map((cartITem, i) => {
          let priceClient =
                        ...
                        <IonCard className="cartCard">
                          <IonCardContent className="cart-content p-0">
                            <IonGrid className="">
                              <IonRow className=" ">
                                <IonCol size="12">
                                  <div className="mainWrapperOrder">
                                    ...
                                    <div className="QtyWrapper">
                                      ...
                                      <div className=" ">
                                        {userType == "client" ? (
                                          ...
                                          >
                                            Price: $
                                            {cartITem.pricing[0].ECommerceCost}
                                          </IonText>
                                        )}
                                        {/* <IonButton
